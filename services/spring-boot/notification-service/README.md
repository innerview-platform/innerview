...
The Notification Service manages outbound communications, including calendar invites, upcoming interview reminders, and system alerts.
...
* **Note:** This service currently does not connect to the database directly, relying on data passed from other services via its REST API.