...
import com.innerview.user.core.handler.OAuth2SuccessHandler;
            ...
            cors ->
                cors.configurationSource(
                    request -> {
                      ...
                      config.setAllowedOrigins(List.of(fronendUrl));
                ...
                oauth2
                    ...
                    .failureHandler(
                        (request, response, exception) -> {
                          ...
                          response.sendRedirect(fronendUrl + "/login?error=" + encodedMessage);
                        }))
